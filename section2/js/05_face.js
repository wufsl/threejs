...
const faceGroup = new THREE.Group(); // 그룹 짓기(눈,코,얼굴 다 마우스를 따라와라 x, 머리통 하나만 따라와라)
...
const init = () => {
    ...
    renderer = new THREE.WebGLRenderer({ antialias: true }); // antialias 기본 설정 true. 더 깔끔함
